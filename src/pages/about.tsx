			...
			<Box>
				...
				<Content>
					...
					<Content.Paragraph>
						...
						applications developer as well as an entrepreneur. When I'm not busy
						developing one of my own projects, you'll probably find me working
						on a clients.
					</Content.Paragraph>
				</Content>
				<Content>
				...
				<Content>
					...
					<Content.Paragraph>
						...
						passion for the business world. I started my 1st at 17, buying 'The
						Lord of the Rings' prop replicas from China to resell them on eBay
						and etsy. 8 years and 3 ventures later, I’ve acquired extensive
						hands on experience in the many aspects of digital marketing,
			...
			<Box>
				...
				<Content>
					...
					<Content.Paragraph>
						...
						'closing the disconnect' between a developer and client. An issue I
						run into time and time again as a freelancer, is efficiently
						communicating with my clients. I am a developer. I work with
						websites all day every day. I know how to make a website that is
						useable, efficient, and meets my clients goals. But before I can,
					...
					<Content.Paragraph>
						...
						of dissconnect. When I begin a new project, I'll ussually sit down
						with the client for aboout an hour. Through a collaborative back and
						forth process, i'll extensively document exactly what it is they're
						envisioning. At the end of this process, I'll have a set of well
						defined features and behaviors to impliment. The process helps the
						client express their vision and me know what to focus on.
					</Content.Paragraph>
				</Content>
				<Content>
					...
					<Content.Paragraph>
						...
						that CEO. That it's not just a dream. It's all about energy. When
						you believe that something you really want is within your
						capabilities, you’re going to be motivated to go get it. You’re not
						just going to be motivated, you’re going to be excited and
				...
				<Tabs>
					<Tabs.Tab initial title="Languages">
						<Content>
							...
							<Content.Paragraph>
								...
								language. PHP is primarily used for web development because it
								pairs well with html, works server side, and is easy to learn.
							</Content.Paragraph>
						</Content>
						...
						<Content>
							...
							<Content.Paragraph>
								...
								It's typically used client side to provide dynamic web browser
								interactivity, but can also be used on the server side as well.
							</Content.Paragraph>
						</Content>
						...
						<Content>
							...
							<Content.Paragraph>
								Swift is a modern general-purpose, and compiled programming
								language developed by Apple. Swift is designed to work with
						...
						<Content>
							...
							<Content.Paragraph>
								GoLang is a modern statically-typed compiled language that is
								being developed by Google. The langauges defining features are
								its small size and support for concurrent programming.
							</Content.Paragraph>
						</Content>
					</Tabs.Tab>
					...
					<Tabs.Tab title="Frameworks">
						<Content>
							...
							<Content.Paragraph>
								Symfony is a PHP web application framework and a set of reusable
								PHP components / libraries. Many of the more well known PHP
								frameworks such as Laravel, and Drupal utilize components of
								this framework.
							</Content.Paragraph>
						</Content>
						<Content>
							...
							<Content.Paragraph>
								...
								described as 'a web application framework with expressive,
								elegant syntax
							</Content.Paragraph>
						</Content>
						<Content>
					...
					<Tabs.Tab title="Tools">
						...
						<Content>
							...
							<Content.Paragraph>
								...
								programming languages. Connect a github repository, and each
						...
						<Content>
							...
							<Content.Paragraph>
								...
								features such as auto-prefixing, future CSS syntax, modules,
								linting and more.
							</Content.Paragraph>
						</Content>
					</Tabs.Tab>
